# 🌌 kaisen
kaisen is an extension repo for [SkyStream](https://github.com/akashdh11/skystream). Follow the guide below to get started and set up your providers.
...
4.  Enter the following Repository URL or shortcode URL:
    > **Repository URL:** `https://raw.githubusercontent.com/Gowaru/kaisen_repo/main/repo.json`
    > **ShortCode URL:** `https://bit.ly/kaisen-repo`
5.  Tap **Add**.
